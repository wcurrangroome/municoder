...
- [`get_changed_sections()`](https://wcurrangroome.github.io/municoder/reference/get_changed_sections.md)
...
- [`get_codes_tree()`](https://wcurrangroome.github.io/municoder/reference/get_codes_tree.md)
  : Get the full table of contents tree for an ordinance in a single
  request
...
- [`get_section_html()`](https://wcurrangroome.github.io/municoder/reference/get_section_html.md)
  : Get raw HTML content and markdown for a given node within a given
  ordinance
